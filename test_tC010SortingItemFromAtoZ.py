...
class TestTC010SortingItemFromAtoZ():
  ...
  def test_tC010SortingItemFromAtoZ(self):
    # Test name: TC010_Sorting Item From A to Z
    ...
    # 8 | click | css=*[data-test="product-sort-container"] | 
